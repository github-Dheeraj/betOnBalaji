...
contract BetOnBalaji {
    ...
    function calculateBonusFactor() public view returns (uint256) {
        ...
        return BONUS_FACTOR_MIN +
            ((deadline - block.timestamp) * (BONUS_FACTOR_MAX - BONUS_FACTOR_MIN)) /
    ...
    function claimReward() external {
        ...
        if(block.timestamp < deadline || !currentStatus.isSettled) revert BettingOpen();
        ...
        uint256 reward = (winnerBet * loserSideTotal) / totalBets[currentStatus.winningSide];
